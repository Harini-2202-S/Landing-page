...
//         "https://script.google.com/macros/s/AKfycbyyKG2k9EdoXwLrJEiL4G7R0-B6_66WcAVg-FHr5r96HpgLrKuNot8dqpLjkkA3gfQ7Zg/exec",
//         {
//           method: "POST",
...
const LandingPage = () => {
  ...
  const [loading, setLoading] = useState(false);
  const [responseMsg, setResponseMsg] = useState(null); 
  const [showPopup, setShowPopup] = useState(false); // NEW for popup
